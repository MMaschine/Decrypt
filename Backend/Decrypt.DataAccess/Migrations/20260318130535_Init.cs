        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metadata_Source = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Metadata_LegacyNumericId = table.Column<int>(type: "int", nullable: true),
                    ...
                    LegacyId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizations_LegacyId",
                table: "Organizations",
                column: "LegacyId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Projects_LegacyId",
                table: "Projects",
                column: "LegacyId",
                unique: true);
